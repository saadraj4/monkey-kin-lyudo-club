...
function index({ openGift, handleCloseGift }) {
  ...
  return (
    <Dialog open={openGift} onClose={handleCloseGift} maxWidth="sm" fullWidth>
      <SoftBox >
        ...
        <DialogContent>
          ...
          <SoftInput placeholder="Quantity" variant="outlined" type="number" fullWidth onWheel={(e) => e.target.blur()} />
