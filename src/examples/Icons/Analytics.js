  ...
  return (
    ...
    >
      <path
        ...
        fill={colors[color] ? colors[color].main : "#758CA3"}
      />
    </svg>
  );
}

// Setting default values for the props of Analytics
Analytics.defaultProps = {
  color: "dark",
  size: "16px",
};

// Typechecking props for the Analytics
Analytics.propTypes = {
